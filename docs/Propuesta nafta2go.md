...
La fuente incluye dirección, bandera, producto, franja horaria, precio y fecha de vigencia. En CABA se identificaron 732 filas correspondientes a nafta. De ellas, 96 filas, asociadas a 29 identificadores, tenían una fecha de vigencia dentro de los treinta días anteriores al relevamiento.  
...
La API histórica informa 41.160 registros asociados con CABA. Se examinaron 10.000 registros y una muestra del CSV vigente. Durante esa exploración se detectó una posible discrepancia en la interpretación de día y mes entre el CSV y la API. Por este motivo, la POC deberá confirmar los formatos y reglas de normalización antes de consolidar ambas fuentes.  
